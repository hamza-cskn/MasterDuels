package mc.obliviate.blokduels.bukkit.kit.serializer;
...
public class KitSerializer {
	...
	private static ItemStack[] deserializeItemList(ConfigurationSection section, int size) {
		...
		for (String key : section.getKeys(false)) {
			Bukkit.broadcastMessage("deserializing: " + section.getCurrentPath() + "." + key);
			Bukkit.broadcastMessage("result: " + section.getItemStack(key));
