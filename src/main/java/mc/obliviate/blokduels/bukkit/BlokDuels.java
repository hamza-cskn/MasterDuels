package mc.obliviate.blokduels.bukkit;

import com.hakan.messageapi.bukkit.MessageAPI;
import mc.obliviate.blokduels.bukkit.commands.DuelArenasCMD;
import mc.obliviate.blokduels.bukkit.commands.DuelCMD;
import mc.obliviate.blokduels.bukkit.commands.KitEditorCMD;
import mc.obliviate.blokduels.bukkit.commands.SetupCMD;
import mc.obliviate.blokduels.bukkit.config.ConfigHandler;
import mc.obliviate.blokduels.bukkit.data.DataHandler;
import mc.obliviate.blokduels.bukkit.data.DatabaseHandler;
import mc.obliviate.blokduels.bukkit.game.Game;
import mc.obliviate.blokduels.bukkit.kit.serializer.KitSerializer;
import mc.obliviate.blokduels.bukkit.listeners.*;
import mc.obliviate.blokduels.bukkit.utils.scoreboard.ScoreboardManager;
import mc.obliviate.blokduels.bukkit.utils.tab.TABManager;
