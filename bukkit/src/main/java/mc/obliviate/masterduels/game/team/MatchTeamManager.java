...
import mc.obliviate.masterduels.api.arena.IMatchTeamManager;
...
public class MatchTeamManager implements IMatchTeamManager {
	...
	public boolean checkTeamEliminated(final ITeam team) {
		final ISpectatorStorage omniSpectatorStorage = team.getMatch().getGameSpectatorManager().getSemiSpectatorStorage();
		Loop1:
		for (IMember member : team.getMembers()) {
